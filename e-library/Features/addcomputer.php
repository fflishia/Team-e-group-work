...
$computer_name = str_replace("'", "\'", $_POST["computer_name"]);
$serial_no = str_replace("'", "\'", $_POST["serial_no"]);


$query = "INSERT INTO computer_info(Computer_Name, Serial_Number) values('$computer_name','$serial_no')"; //Insert query to add book details into the appropriate table
...
<body>
    ...
    <main>
        <h1 class="title"> Computer is added successfully </h1>
